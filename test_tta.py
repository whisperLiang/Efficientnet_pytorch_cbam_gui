...
print("2")
tta_model = tta.ClassificationTTAWrapper(model, transform, merge_mode='mean')
# criterion = loss.CrossEntropyLabelSmooth(10, epsilon=0.1)
criterion = loss.CrossEntropy(10, epsilon=0.1)
val_acc, val_loss = validate(val_loader, tta_model, criterion)
